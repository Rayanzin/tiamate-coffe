const BoasVindas = () => {
  return (
    <section className="w-full flex gap-[43px] items-center bg-bgcard">
      <div className="w-[56%] h-[700px] ">
        <img
          className="w-full h-full object-cover object-[5%_0%]"
      ...
      <div className="w-[44%]">
        <div className=" pr-[135px]">
          ...
          <p className="text-[16px] font-normal leading-[120%] text-letras2 mb-[20px]">
            ...
            sabor do café e o seu espírito inovador. Visamos fazer parte da vida
            das pessoas e diferentes culturas, isso é o que nos motiva a
          ...
          <p className="text-[16px] font-normal leading-[120%] text-letras2">
            ...
            manhã ou em uma reunião. Individualmente ou entre amigos. À Tiamate
            Coffee investe em um conceito atual que transmite as pessoas uma
            sensação de bem estar. Enquanto nosso café aproxima as pessoas,
            nossos serviços de Wifi gratuito as mantém conectadas. Descubra como
            navegar na internet enquanto você saboreia um Tiamate.
          </p>
        </div>
      </div>
    </section>
