...
const Menu = () => {
  ...
  // 2xl -> 1535px
  return (
    <section className=" w-full pt-[80px] pb-[190px] px-[10px]">
      <div className="flex justify-between max-w-[1170px] m-auto">
        <ul className="flex flex-col gap-[35px]">
          {cardapio.map((categorias, index) => (
            <li className="text-[18px] font-medium text-letras2 " key={index}>
              <div className="flex items-center gap-[23px] max-sm:gap-[12px]">
                <span
        ...
        <ul className="m-auto grid grid-cols-3 gap-[80px] max-xl:grid-cols-2 max-md:grid-cols-1">
          {itens.map((item) => (
            <li className="w-[223px] h-[222px] flex flex-col items-center max-sm:w-[180px] max-sm:h-[180px]">
