const HeaderModular = ({
  ...
  return (
    <section className="relative m-auto w-full h-[490px] max-lg:h-[400px] duration-200 max-md:h-[300px] ">
      <div className="absolute z-0 w-full h-full">
        <img className="w-full h-full " src={imagem} alt="café" />
      </div>
      <div className="relative h-full m-auto">
        <div
          className={`z-10 relative top-[110px] w-[1170px] m-auto ${className} max-md:top-[50px] max-sm:top-[70px]`}
        >
