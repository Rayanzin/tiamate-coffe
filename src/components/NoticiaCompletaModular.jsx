...
const NoticiaCompletaModular = ({ img, titulo, href, className }) => {
  return (
    <div className="w-[370px]">
      ...
      <ButtonModular type={`default`} className={`!w-[100%] ${className} !bg-transparent !border-letras3 hover:!bg-primaria !text-primaria hover:!text-letras2 active:!bg-quaternaria active:cursor-progress`} link={href} buttonName={`Notícia Completa`} />
    </div>
  );
};
